...
-- =============================================
drop trigger if exists trigger_recalc_post_views on post_views;
drop trigger if exists trigger_recalc_comments on comments;
drop trigger if exists trigger_recalc_likes on likes;

-- =============================================
-- 🔥 1️⃣ FUNCTION: Recalculate Views & Creator Views
-- =============================================
create or replace function recalc_views_all()
returns trigger
language plpgsql
as $$
begin
...
-- =============================================
-- 🔥 2️⃣ TRIGGER: Post Views Table
-- =============================================
create trigger trigger_recalc_post_views
after insert or update or delete on post_views
for each row
execute function recalc_views_all();

-- =============================================
-- 🔥 3️⃣ FUNCTION: Recalculate Comments
-- =============================================
create or replace function recalc_comments_all()
returns trigger
language plpgsql
as $$
begin
...
-- =============================================
-- 🔥 4️⃣ TRIGGER: Comments Table
-- =============================================
create trigger trigger_recalc_comments
after insert or update or delete on comments
for each row
execute function recalc_comments_all();

-- =============================================
-- 🔥 5️⃣ FUNCTION: Recalculate Likes
-- =============================================
create or replace function recalc_likes_all()
returns trigger
language plpgsql
as $$
begin
...
-- =============================================
-- 🔥 6️⃣ TRIGGER: Likes Table
-- =============================================
create trigger trigger_recalc_likes
after insert or update or delete on likes
for each row
execute function recalc_likes_all();
